...
using ProductsAndPricingNew.Application.Common.Validation.Patterns;
        ...
        return rule.Must(value =>
            {
                ...
                return ValidationPatterns.EmailRegex.IsMatch(value.Trim());
            })
        ...
        return rule.Must(value =>
            {
                ...
                if (!ValidationPatterns.PhoneRegex.IsMatch(formatted))
                    return false;
        ...
        return rule.Must(url =>
            {
                ...
                return ValidationPatterns.HttpUrlRegex.IsMatch(url.Trim());
            })
